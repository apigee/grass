...
exports.getConsent = function(req, res) {
  ...
  console.log('getConsent: in the flow to get consent');
  // intercept OPTIONS method
  if ('OPTIONS' == req.method) {
    res.send(200);
  }
...
exports.validateConsent = function(req, res) {
  ...
  console.log('validateConsent: in the flow to get consent');

  console.log('UG details:');
  console.log('orgName: ' + pkginfo.orgName);
  console.log('appName: ' + pkginfo.appName);
  console.log('authType: ' + Usergrid.AUTH_CLIENT_ID );
  console.log('clientId: ' + pkginfo.client_id);
  console.log('clientSecret: ' + pkginfo.client_secret);
