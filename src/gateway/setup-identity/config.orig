...
sed -i "" "s,__BAASURI__,$baasuri,g" ../identity-consentmgmt-api/config.json
...
sed -i "" "s,__BAASURI__,$baasuri,g" ../identity-consentmgmt-api-node-module/consentmgmt/package.json
...
sed -i "" "s,__BAASURI__,$baasuri,g" ../identity-usermgmt-api/config.json
