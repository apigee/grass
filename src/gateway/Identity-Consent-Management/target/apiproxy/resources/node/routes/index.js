...
//									status = response.entities[0].status;
    ...
    exports.SSOaction = function(req, res) {
    	...
    	client.request(options,function(error, response) {
    		...
    		if (error || response == null || response.entities[0]== null || response.entities[0].consent_id == null) {
							...
							} else if(token_life != null && (parseFloat(response.entities[0].last_updated) + parseFloat(token_life)) < parseFloat(current_time)){
    									...
    									client.request(consentQuery,function(error, consent) {
    														...
    														res.send(responseConsent);
    																...
    																var ssoData = {
    																	...
    																	client.request(ssoData, function(err, data) {
    																		if (err) {
    																			var error={
    																					"error_code": "server_error",
    																		...
    																		if (err) {
    																			...
    																			res.send(500,error);
    																				...
    																				var consentData = {
    																					...
    																					client.request(consentData, function(err, data) {
    																						if (err) {
    																							var error={
    																									"error_code": "server_error",
    ...
    res.header('Content-Type', 'application/json');
	...
	} else if (req.query.authorization_code != null && req.query.authorization_code != "") {
   	...
   	{ 		endpoint:'consents', 
   		...
   		if (queryString != null && (req.query.consent_id != null || queryParam == "authorization_code" || queryParam == "access_token")) {
   	...
   	exports.createSSO=function(req, res) {
   		...
   		var options = 
   	   	{ 		endpoint:'consents', 
   	   			qs:{ql: "access_token = '" + access_token + "'"}
   	   	 }
       ...
       res.header('Content-Type', 'application/json');
      	...
      	var queryString="";
   		...
   		queryString = "end_user_id = '" + req.query.user_id +"' and client_id = '"+req.query.client_id+"'";
